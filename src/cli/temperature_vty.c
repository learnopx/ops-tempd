 ...
 * @detail      : Add temperature related table & columns to ops-cli
 *                idl cache
 *******************************************************************/
void tempd_ovsdb_init(void)
{
    /* Add temperature tables. */
    ovsdb_idl_add_table(idl, &ovsrec_table_temp_sensor);

    /*Add temp_sensors into subsystem */
...
/* Initialize ops-tempd cli element.
 */
